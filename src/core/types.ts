...
export interface Bone {
  ...
  opacity?: number;
  /** True when this bone was generated by a SkeletonParagraph — intentional approximation, not a layout error. */
  isParagraph?: boolean;
...
export interface MeasuredLayout {
  ...
  /**
   * Estimated rendered text width (char count × font size × 0.55).
   * Only populated for 'text' leaf nodes during devtools fiber walk.
   * Used by waste scoring to distinguish text coverage from bone area.
   */
